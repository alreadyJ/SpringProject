...
<%SaleList sale = (SaleList) request.getAttribute("sale");%>
...
<div class="container mt-5 pt-3">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="dark-grey-text pl-0">
                                    <p><%=sale.getRemainQuantity()%> / <%=sale.getQuantity()%></p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
    ...
    <section id="reviews" class="pb-5">
        ...
        <div class="comments-area">
            ...
            <input id="comment-item-serial" type="hidden" name="itemSerial" value="<%=sale.getSerial()%>">
            <input id="comment-user-nickName" type="hidden" name="userNickName" value="<%=user.getNickName()%>">
            <input id="comment-type" type="hidden" name="commentType" value="0">
            </c:if>
    ...
    <div class="divider-new">
        <h3 class="h3-responsive font-bold black-text mx-3">Related Products</h3>
    </div>
